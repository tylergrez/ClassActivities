...
function childScope(param) {
  ...
  console.log("Child Scope, Parent Variable:", param);//print
  console.log("Child Scope, Child Variable:", childVariable); // print
}

function parentAndChildScope() {
  const parentVariable = "I am in the parent's scope";
  childScope(parentVariable);
  console.log("Parent Scope, Parent Variable:", parentVariable); // print
  console.log("Parent Scope, Child Variable:", childVariable); //no print
}
