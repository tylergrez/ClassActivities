...
const catchBs = [];
// data.forEach(item => {
//   let catch = item.company.catchPhrase;
//   let bs = item.company.bs;
//   let combined = `${catch} ${bs}`; // did not work, need to debug token error undefined for catch
//   catchBs.push(combined);
// });
// console.log(catchBs);
